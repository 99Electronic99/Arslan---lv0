...
String dizzy = JOptionPane.showInputDialog("how dizzy do you wånt the tortoise to be?");
	 int x = Integer.parseInt(dizzy);     // 1. Use the dance method to make the Tortoise spin.
	        dance(x);
	    }
